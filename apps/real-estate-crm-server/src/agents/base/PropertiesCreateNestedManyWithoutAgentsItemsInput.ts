...
@InputType()
class PropertiesCreateNestedManyWithoutAgentsItemsInput {
...
export { PropertiesCreateNestedManyWithoutAgentsItemsInput as PropertiesCreateNestedManyWithoutAgentsItemsInput };
